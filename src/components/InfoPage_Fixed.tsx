      ...
      <div className="info-content">
        ...
        <div className="info-footer">
          <div className="footer-warning">
            ...
            <p>While Gizli implements military-grade encryption, remember that security depends on proper usage. Always verify peer identities and keep your devices secure.</p>
          </div>
